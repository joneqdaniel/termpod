...
constexpr inline  b8<1>    file_verify(u8<1>* buf) { return    checksum == crc32::mpeg2::compute(&buf[sizeof(checksum) + sizeof(ident)], sizeof(struct header) - sizeof(checksum) - sizeof(ident)); } 
